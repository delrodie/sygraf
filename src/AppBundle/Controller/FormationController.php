...
class FormationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('formation_new');
        }

        // liste des formation
        $em = $this->getDoctrine()->getManager();
        $formations = $em->getRepository('AppBundle:Formation')->findDesc();
     ...
     *
     * @Route("/{slug}", name="formation_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="formation_edit")
     * @Method({"GET", "POST"})
     */
