...
class Chef
{
     ...
     * @var string
     *
     * @ORM\Column(name="classe", type="string", length=1, nullable=true)
     */
    private $classe;
     ...
     *
     * @Vich\UploadableField(mapping="chef_image", fileNameProperty="imageName", size="imageSize", nullable=true)
     *
     * @var File
     */
    private $imageFile;
